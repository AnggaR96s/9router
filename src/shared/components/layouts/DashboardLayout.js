...
export default function DashboardLayout({ children }) {
  ...
  return (
    <div className="dashboard-shell flex w-full overflow-clip bg-bg">
      ...
      <main className="flex flex-col flex-1 h-full min-w-0 relative transition-colors duration-300 isolate">
        ...
        <div className={`flex-1 overflow-y-auto overscroll-contain custom-scrollbar ${pathname === "/dashboard/basic-chat" ? "" : "p-6 lg:p-10"} ${pathname === "/dashboard/basic-chat" ? "flex flex-col overflow-hidden" : ""}`}>
