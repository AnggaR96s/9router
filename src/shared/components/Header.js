...
import { getPageInfo } from "@/shared/components/pageInfo";
...
export default function Header({ onMenuClick, showMenuButton = true }) {
  ...
  return (
    <header className="sticky top-0 shrink-0 flex items-center justify-between gap-3 px-4 lg:px-8 pt-3 pb-2 border-b border-border-subtle bg-surface/60 backdrop-blur-xl lg:bg-transparent lg:backdrop-blur-none z-20">
      {/* Mobile menu button */}
