      ...
      <Card className="p-5 border-black/5 dark:border-white/5 bg-surface space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          <div className="p-3 rounded-lg bg-black/5 dark:bg-white/5">
            ...
            <span className="text-[10px] text-text-muted">data.sqlite</span>
          </div>
          <div className="p-3 rounded-lg bg-black/5 dark:bg-white/5">
          ...
          <div className="p-3 rounded-lg bg-black/5 dark:bg-white/5 last:col-span-2 sm:last:col-span-1">
        ...
        <div className="p-3 rounded-lg border border-primary/20 bg-primary/5">
          <div className="flex items-center justify-between gap-3">
            ...
            <span className="text-lg font-bold text-primary font-mono shrink-0">
              {formatBytes(storage.totalStorageBytes)}
            </span>
          </div>
          <p className="text-[11px] text-text-muted font-mono break-all mt-1" title={storage.dbPath}>
            {storage.dbPath}
          </p>
        </div>
